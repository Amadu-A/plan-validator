# services/embedding-service/src/embedding_service/transport/middleware.py

"""Pure ASGI correlation middleware Embedding Service."""
...
class RequestContextMiddleware:
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        """Создаёт bounded context только для HTTP protocol."""
        if scope["type"] != "http":
        ...
        async def send_with_context(message: Message) -> None:
            """Добавляет request identifiers в response headers."""
