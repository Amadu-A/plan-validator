...
EmbeddingDtype = Literal["bfloat16", "float16"]
...
class EmbeddingModelSettings(BaseModel):
    ...
    output_dimension: int = Field(default=4096, ge=64, le=4096)
    ...
    @property
    def min_free_ram_bytes(self) -> int:
...
class EmbeddingWorkerSettings(EmbeddingSettings):
    ...
    def broker_url(self) -> str:
        ...
        return (
            ...
            f"{self.embedding_broker.port}/{virtual_host}"
        )
