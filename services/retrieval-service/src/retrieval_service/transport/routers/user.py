# services/retrieval-service/src/retrieval_service/transport/routers/user.py

"""Internal typed user U retrieval endpoint."""
...
router = APIRouter(
    prefix="/internal/v1/retrieval/user",
    tags=["internal-user-retrieval"],
)
...
async def search_user_sources(
    ...
    """Ищет только user-provided U evidence текущего explicit tenant user_id."""
    query = SearchQuery(
