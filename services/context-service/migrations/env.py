# services/context-service/migrations/env.py

"""Alembic environment Context Service."""

import asyncio

import context_service.infrastructure.database.models  # noqa: F401
from alembic import context
from context_service.core.settings import load_context_settings
...
def run_sync_migrations(connection: object) -> None:
    ...
    context.configure(
        ...
        compare_type=True,
        version_table="context_alembic_version",
    )
