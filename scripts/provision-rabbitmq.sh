...
load_policy_settings() {
  ...
  WORK_QUEUE_CONSUMER_TIMEOUT_MS="${PLAN_VALIDATOR_RABBITMQ_WORK_QUEUE_CONSUMER_TIMEOUT_MS:-720000}"

  CATALOG_QUEUE_TTL_MS="${PLAN_VALIDATOR_RABBITMQ_CATALOG_EVENT_QUEUE_TTL_MS:-604800000}"
  CATALOG_QUEUE_CONSUMER_TIMEOUT_MS="${PLAN_VALIDATOR_RABBITMQ_CATALOG_EVENT_QUEUE_CONSUMER_TIMEOUT_MS:-300000}"
